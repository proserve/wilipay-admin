                    ...
                    <div class="m-stack__item m-brand  m-brand--skin-light ">
                        <div class="m-stack m-stack--ver m-stack--general">
                            <div class="m-stack__item m-stack__item--middle m-brand__logo">
                                <a href="{{route('home')}}" style="transform: rotate(180deg)"
            ...
            <div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-light ">
                ...
                >
                    <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
                        ...
                        <li class="m-menu__section"></li>
                        <li class="m-menu__item{{Route::currentRouteName() == 'customers' ? ' m-menu__item--active ' : '' }}"
                            aria-haspopup="true" m-menu-submenu-toggle="hover" m-menu-link-redirect="1">
                        ...
                        <li class="m-menu__item{{Route::currentRouteName() == 'customers' ? ' m-menu__item--active ' : '' }}"
                            aria-haspopup="true" m-menu-submenu-toggle="hover" m-menu-link-redirect="1">
                            <a href="{{ route('customers') }}" class="m-menu__link">
                                <i class="m-menu__link-icon m-menu__link-icon ion-card"></i>
                        ...
                        <li class="m-menu__item{{Route::currentRouteName() == 'customers' ? ' m-menu__item--active ' : '' }}"
                            ...
                            <a href="{{ route('customers') }}" class="m-menu__link">
                                ...
                                <i class="m-menu__link-icon m-menu__link-icon flaticon-list-3"></i>
